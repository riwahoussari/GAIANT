...
export default function Hero({
  ...
  return (
    <section className="relative">
      ...
      {/* text content */}
      <div className="side-padding my-container relative pt-[200px] pb-[140px] text-white xl:pt-[280px]">
        <p className="mb-5 font-ibm! text-[16px] xs:text-[18px]">{subtitle}</p>
        <div className="flex flex-col lg:flex-row lg:gap-[40px] xl:gap-[56px]">
          <h1
            className={
