      ...
      <div className="relative">
        ...
        >
          ...
          >
            ...
            {withBall && (
              <div className="absolute w-1/3 -translate-x-1/4 translate-y-1/2 max-lg:bottom-0 max-lg:left-0 max-lg:opacity-90 lg:top-0 lg:right-0 lg:translate-x-1/2 lg:-translate-y-1/2">
                <GradientCircle
          ...
          {/* text */}
          <div className="relative z-2 max-w-[550px] space-y-2 lg:w-45/100">
