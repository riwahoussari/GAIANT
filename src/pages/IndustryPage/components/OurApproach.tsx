    ...
    <section ref={sectionRef} className="relative z-2 side-padding my-container mt-[120px]">
      <div className="grid grid-cols-1 items-end gap-2 md:grid-cols-2 md:gap-8 xl:grid-cols-3 xl:gap-5 2xl:gap-8">
        ...
        <SlideUpAnim
          ...
          className="xl:col-span-2 max-sm:-mt-5"
        >
          <p className="text-16 max-w-[432px]">{content.text}</p>
        </SlideUpAnim>
      </div>

      <div className="mt-8 sm:mt-12 md:mt-16 grid grid-cols-1 gap-5 max-md:max-w-[520px] md:grid-cols-2 md:gap-8 xl:grid-cols-3 xl:gap-5 2xl:gap-8 ">
        <SlideUpAnim
          initial={{ y: "50px" }}
